...
static char *fulluseragent  = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36"; 
...
static char *searchengine = "https://www.startpage.com/do/dsearch?query=";
...
#define HOMEPAGE "https://www.startpage.com"
...
#define SETPROP(r, s, p) { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "| dmenu -fn 'inconsolata:size=16' -i -l 10 -p \"$4\" -w $1)\" && " \
...
* 	`cat ~/.surf/bookmarks | dmenu -fn 'inconsolata:size=12' || exit 0`", \
*	  winid, NULL } }
*/
...
/*#define BM_RM { .v = (char *[]){ "/bin/sh", "-c", \
* 	"url=`xprop -id $0 _SURF_URI | cut -d '\"' -f 2` && \
* 	sed -i \"\|\^$url\$\|\d\" ~/.surf/bookmarks", \
* 	winid, NULL } }
*/
...
/*{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_b,      spawn,      BM_PICK },*/
/*{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_b,      spawn,      BM_RM },*/
